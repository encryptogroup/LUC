...
public:
  ...
  uint32_t PutUniversalGate(std::vector<uint32_t> input_wires, std::vector<uint32_t> lut_programming);
  std::vector<uint32_t> PutUniversalGate(std::vector<uint32_t> a, std::vector<uint32_t> b, std::vector<uint32_t> lut_programming);
  share* PutUniversalGate(share* a, share* b, std::vector<uint32_t> lut_programming);
...
std::vector<uint32_t> PutMultiInOutUniversalCircuitFromFile(const std::string filename, const std::string p1filename, std::vector<uint32_t> 	p2inputs, uint32_t nvals,e_sharing sharing);
	/**
  ...
  uint32_t PutUniversalGateCircuit(std::vector<uint32_t> input_wires, std::vector<uint32_t> lut_programming);
